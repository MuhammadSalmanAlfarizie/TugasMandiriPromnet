...
const NAMA_KEDAI = ("Kopi PSTI UPI PURWAKARTA");

let namaKasir = ("Kak Salman");
let shiftKerja = ("Pagi");
...
alert("Selamat Datang di Kedai Kopi PSTI!");
let namaPelanggan = prompt("Halloo! Masukkan Nama Kamu Untuk Memesan");

if(namaPelanggan) {
    alert("Halooo!, " + namaPelanggan + "Selamat Memesan di Kedai Kopi PSTI Yaakk");
} else {
...
console.log("Nilai Total Kamu Adalah : " + totalPoin);
...
function tentukanTierMember(poin) {
    ...
    if (poin >= 70) return "Gold - Member Loyal";
    if (poin >= 40) return "Silver - Member Premium";
